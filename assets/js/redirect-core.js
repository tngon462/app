// Load links.json và tạo nút bàn
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    Object.keys(links).forEach((key) => {
      ...
      btn.className = "px-6 py-3 rounded-lg bg-blue-500 text-white font-bold hover:bg-blue-700 w-28 h-20 text-xl shadow";
      ...
      btn.addEventListener("click", () => {
        ...
        document.getElementById("start-order").setAttribute("data-url", links[key]);
